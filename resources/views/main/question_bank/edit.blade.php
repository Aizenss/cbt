...
<form method="POST" class="row g-3" id="formEdit" action="{{ route('question-bank.update', $data->id) }}"
    ...
    <div class="col-12 col-md-12">
        ...
        <textarea id="question" name="question" class="form-control" placeholder="soal" rows="5">{{ $data->question }}</textarea>
    ...
    <div class="col-12 col-md-12">
        ...
        <textarea id="option_a" name="option_a" class="form-control" placeholder="Pilihan A">{{ $data->option_a }}</textarea>
    </div>

    <div class="col-12 col-md-12">
        <label class="form-label" for="option_b">Option B <span class="text-danger"></span></label>
        <textarea id="option_b" name="option_b" class="form-control" placeholder="Pilihan B">{{ $data->option_b }}</textarea>
    </div>

    <div class="col-12 col-md-12">
        <label class="form-label" for="option_c">Option C <span class="text-danger"></span></label>
        <textarea id="option_c" name="option_c" class="form-control" placeholder="Pilihan C">{{ $data->option_c }}</textarea>
    </div>

    <div class="col-12 col-md-12">
        <label class="form-label" for="option_d">Option D <span class="text-danger"></span></label>
        <textarea id="option_d" name="option_d" class="form-control" placeholder="Pilihan D">{{ $data->option_d }}</textarea>
    </div>

    <div class="col-12 col-md-12">
        <label class="form-label" for="option_e">Option E <span class="text-danger"></span></label>
        <textarea id="option_e" name="option_e" class="form-control" placeholder="Pilihan E">{{ $data->option_e }}</textarea>
    </div>
    ...
    <div class="col-12 col-md-12" id="correctAnswerParent">
        ...
        <select id="correct_answer" name="correct_answer" class="select2 form-select select2-primary" required>
            <option value="option_a" {{ $data->correct_answer == 'option_a' ? 'selected' : '' }}>A</option>
            <option value="option_b" {{ $data->correct_answer == 'option_b' ? 'selected' : '' }}>B</option>
            <option value="option_c" {{ $data->correct_answer == 'option_c' ? 'selected' : '' }}>C</option>
            <option value="option_d" {{ $data->correct_answer == 'option_d' ? 'selected' : '' }}>D</option>
            <option value="option_e" {{ $data->correct_answer == 'option_e' ? 'selected' : '' }}>E</option>
        </select>
    </div>
