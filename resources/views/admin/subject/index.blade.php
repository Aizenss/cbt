...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Halaman Mata Pelajaran /</span> Home</h4>
...
@push('js')
    <script type="text/javascript">
        ...
        function editData(id) {
            ...
            $.ajax({
                    url: "{{ route('subject.edit', ':id') }}".replace(':id', id),
                    type: 'GET',
                })
                .done(function(data) {
                    $('#content-modal-ce').html(data);
