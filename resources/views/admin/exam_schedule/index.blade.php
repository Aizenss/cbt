...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Halaman Jadwal Ujian /</span> Home</h4>
        ...
        function init_table(keyword = '') {
            ...
            var table = $('#data-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'can_be_completed_time',
                        name: 'can_be_completed_time'
                    },
                    {
                        data: 'action',
                        name: 'action',
