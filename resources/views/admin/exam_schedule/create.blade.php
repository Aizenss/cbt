...
<div class="text-center mb-4">
    <h3 class="mb-2">Tambah Ujian</h3>
    <p class="text-muted">Tambahkan Data Sesuai Dengan Informasi Yang Tersedia</p>
</div>
<form method="POST" class="row g-3" id="formCreate" action="{{ route('exam-schedule.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-12 col-md-12">
        ...
        <input type="number" id="total_time" name="total_time" class="form-control" placeholder="waktu pengerjaan"
            required />
    </div>
    ...
    <div class="col-12 col-md-12">
        ...
        <input type="number" id="can_be_completed_time" name="can_be_completed_time" class="form-control"
            placeholder="waktu selesai sebelum" required />
    </div>
