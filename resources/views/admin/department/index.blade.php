...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Halaman Jurusan /</span> Home</h4>
...
@push('js')
    <script type="text/javascript">
        ...
        function showData(id) {
            window.location.href = "{{ route('question-bank.index') }}?id=" + id;
        }
        ...
        function deleteData(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('department.destroy', ':id') }}".replace(':id', id),
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
        ...
        function bulkDelete(ids) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('department.destroyAll') }}",
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
