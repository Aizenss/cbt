...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Halaman Kelas /</span> Home</h4>
...
@push('js')
    <script type="text/javascript">
        ...
        function createData() {
            $.ajax({
                    url: "{{ route('departement-class.create') }}",
                    type: 'GET',
                })
                .done(function(data) {
        ...
        function editData(id) {
            ...
            $.ajax({
                    url: "{{ route('departement-class.edit', ':id') }}".replace(':id', id),
                    type: 'GET',
                })
                .done(function(data) {
                    $('#content-modal-ce').html(data);
        ...
        function showData(id) {
            window.location.href = "{{ route('departement-class.show', ':id') }}".replace(':id', id);
        }
        ...
        function deleteData(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('departement-class.destroy', ':id') }}".replace(':id', id),
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
        ...
        function bulkDelete(ids) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                            url: "{{ route('departement-class.destroyAll') }}",
                            type: 'POST',
                            data: postForm,
                            dataType: 'json',
                        })
