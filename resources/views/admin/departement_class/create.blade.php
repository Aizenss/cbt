...
<div class="text-center mb-4">
    <h3 class="mb-2">Tambah Kelas</h3>
    <p class="text-muted">Tambahkan Data Sesuai Dengan Informasi Yang Tersedia</p>
</div>
<form method="POST" class="row g-3" id="formCreate" action="{{ route('departement-class.store') }}"
    ...
    <div class="col-12 col-md-12">
        ...
        <input type="text" id="alias" name="alias" class="form-control" placeholder="singkatan" required />
    </div>

    <div class="col-12 col-md-12">
        <label class="form-label" for="identity">Identitas<span class="text-danger">*</span></label>
        <input type="number" id="identity" name="identity" class="form-control" placeholder="identitas" required />
    </div>
